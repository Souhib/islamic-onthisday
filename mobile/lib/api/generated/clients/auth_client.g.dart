...
class _AuthClient implements AuthClient {
  ...
  @override
  Future<UserPublic> meApiV1AuthMeGet({String? authorization}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  Future<UserPublic> changeDisplayNameApiV1AuthMePatch({
    required ChangeDisplayNameRequest body,
  ...
  @override
  Future<void> deleteAccountApiV1AuthMeDelete({String? authorization}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'Authorization': authorization};
  ...
  Future<void> verifyEmailApiV1AuthEmailVerifyPost({
    required EmailVerifyConfirm body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<void> resendVerificationEmailApiV1AuthEmailResendPost({
    required EmailVerifyResend body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<UserPublic> confirmEmailChangeApiV1AuthMeEmailConfirmPost({
    required ChangeEmailConfirm body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
