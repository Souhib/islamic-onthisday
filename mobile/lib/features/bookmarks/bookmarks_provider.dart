...
import 'package:iotd_mobile/api/generated/models/bookmark_create.dart';
import 'package:iotd_mobile/api/generated/models/bookmark_create_target_kind.dart';
import 'package:iotd_mobile/api/generated/models/bookmark_list.dart';
import 'package:iotd_mobile/api/generated/models/bookmark_out.dart';
...
class BookmarksNotifier extends AsyncNotifier<List<BookmarkOut>> {
  ...
  Future<List<BookmarkOut>> build() async {
    final client = ref.watch(iotdClientProvider).bookmarks;
  ...
  Future<void> add({
    ...
    final client = ref.read(iotdClientProvider).bookmarks;
