// IotdWidget.swift
//
// WidgetKit extension source for the Islamic On This Day app.
...
// suggestion: app.iotd.mobile.IotdWidget.
//
// To make App Group sharing work:
//
//   1. In Xcode → Signing & Capabilities for *both* Runner and the
//      IotdWidget target, add the same App Group:
//      `group.app.iotd.mobile`.
...
private struct IotdEntry: TimelineEntry {
    let date: Date
    let hijriDay: Int
...
private struct IotdProvider: TimelineProvider {
