...
//  headline) — fed from the App Group `group.app.thaqafa.app`
...
struct ThaqafaEntry: TimelineEntry {
    let date: Date
    let hijriDay: Int
...
struct ThaqafaProvider: TimelineProvider {
...
private struct ThaqafaSmallView: View {
    ...
    var body: some View {
        ...
        .padding(16)
        .containerBackground(for: .widget) { ThaqafaTokens.paper }
    }
}
