...
from thaqafa.api.constants import EVENT_PEOPLE_LIMIT, EVENT_SOURCES_LIMIT, HIJRI_MONTH_NAMES_SHORT
from thaqafa.api.schemas.event import (
    DisputedPosition,
    EventDetail,
    EventSummary,
    PersonRef,
...
from thaqafa.api.schemas.lesson import LessonDetail, LessonSummary
