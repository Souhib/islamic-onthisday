...
from iotd.api.errors import BookmarkNotFoundError, BookmarkTargetNotFoundError
from iotd.api.schemas.bookmark import BookmarkCreate, BookmarkList, BookmarkOut
from iotd.models.user import Bookmark, BookmarkTargetKind
