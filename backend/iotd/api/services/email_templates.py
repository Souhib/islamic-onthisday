...
Templates live in ``iotd/email_templates/*.{html,txt}`` and ship inside
...
# ``iotd/email_templates/`` inside the installed wheel.
...
def _get_env() -> Environment:
    ...
    if _env is None:
        _env = Environment(
            loader=PackageLoader("iotd", "email_templates"),
